...
/data/users/jsanjak/ESMtest/src/esmk -o bigfake.esmpv.txt -w 10000 -j 1000 -k 50 -n $CORES -r 0.5 --cmarkers 50 --cperms 10000 --nperms 100000 bigfake.1.perms.h5 bigfake.2.perms.h5
