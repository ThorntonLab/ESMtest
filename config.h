...
/* Is boost algorithm string header found? */
#define HAVE_BOOST_ALGORITHM_STRING 1

/* Is boost bind header found? */
#define HAVE_BOOST_BIND 1

/* Is boost program options header found? */
#define HAVE_BOOST_PROGRAM_OPTIONS 1

/* Is boost unordered map header found> */
...
#define PACKAGE_BUGREPORT "https://github.com/ThorntonLab/ESMtest"

/* Define to the full name of this package. */
#define PACKAGE_NAME "ESM"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "ESM 0.1.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "esm"
